...
export default function DashboardContent({ tasks, stats, plan }: DashboardContentProps) {
  const { isOpen, task, defaultStatus, openDialog, closeDialog } = useTaskDialog();

  return (
    <>
      <div className="space-y-6">
        {/* Quick Actions Banner */}
        <QuickActions onNewTask={() => openDialog()} />

        {/* Stats Cards Grid */}
        <StatsCards stats={stats} plan={plan} />
